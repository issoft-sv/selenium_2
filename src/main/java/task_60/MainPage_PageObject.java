...
public class MainPage_PageObject {
        private WebDriver driver;

        public MainPage_PageObject(WebDriver driver) {
            this.driver = driver;
        }
        ...
        public MainPage_PageObject signIn (String username, String password) {
        ...
        public MainPage_PageObject signOut () {
            driver.findElement(firstSigInButton).click();
